...
echo "  MCP:    registered with Claude Code / opencode / Kilo Code / Codex, whichever are on PATH"
echo "  Skill:  installed for auto-invocation in Claude Code / Codex (opencode/Kilo: see AGENTS.md)"
