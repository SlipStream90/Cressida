...
# whichever of Claude Code / opencode / Kilo Code / Codex are found on this machine.
#
...
Write-Host "  MCP:    registered with Claude Code / opencode / Kilo Code / Codex, whichever are on PATH"
Write-Host "  Skill:  installed for auto-invocation in Claude Code / Codex (opencode/Kilo: see AGENTS.md)"
